...
function setFeatured(r){featuredTitle.textContent=r.title;featuredMeta.textContent=`${r.source} · ${r.category}`;featuredLink.href=r.url;featuredLink.dataset.featuredId=r.id;featuredImage.src=artForCategory(r.category);featuredImage.alt=`${r.category} featured artwork`}
